...
'''
    ...
    comments:
        susan corner detector is suceptable to noise since the image is embedded with
        salt and pepper noise corner detection algorithm is greatly suffered as it falsely treats all the noise as corners.
...
print("susan corner detector is suceptable to noise since the image is embedded with salt and pepper noise corner detection algorithm is greatly suffered as it treats all the noise as corners")
